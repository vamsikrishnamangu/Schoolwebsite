  ...
  return (
    <>
      <div className="bg-[#F1F5F9] bg-cover w-[88vw] h-[100vh]">
        ...
        <div className="font-[Roboto] flex flex-col  2xl:w-[656px] 2xl:h-[453px] lg:w-[600px] lg:h-[400px] rounded-3xl 2xl:mt-[34px] lg:mt-[24px] bg-[#FFFFFF] 2xl:ml-[90px] lg:ml-[50px] mr-[32px] relative">
