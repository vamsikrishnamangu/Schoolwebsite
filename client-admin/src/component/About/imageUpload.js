...
const ImageUpload = () => {
  ...
  return (
    <div>
      ...
      >
        {!image ? (
          <div className="2xl:ml-[32px] lg:ml-[90px] flex flex-col items-center justify-center 2xl:w-[378px] lg:w-[250px] 2xl:h-[152px] lg:h-[150px] lg:pt-[20px] rounded bg-[#C2C2C28F]">
            ...
            <p className="text-sm lg:text-xs text-gray-500   mt-[11px] 2xl:ml-[150px] lg:ml-[50px]">
      ...
      <div className="absolute bottom-[40px] 2xl:ml-[480px] lg:ml-[400px] transform -translate-x-1/2">
