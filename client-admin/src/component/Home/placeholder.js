...
const Placeholder = () => {
  ...
  return (
    <div className="flex flex-col ">
      <div>
        <p className="lg:ml-[40px] 2xl:ml-[90px] mt-[18px] font-semibold text-xl font-Roboto text-[#1A2338B2]">
          Free Placeholder
        </p>
      </div>
      {slides.map((slideNum) => (
      ...
      <button
        className=" 2xl:ml-[800px]  lg:ml-[600px]  w-[134px] h-[50px]  border-2 border-gray-500 rounded-lg mt-[4px]"
