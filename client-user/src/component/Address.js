...
const Address = () => {
  return (
    <div>
      <div className="font-roboto-sans flex-1 lg:ml-[5rem] ml-[24px]  p-4 ">
        <h1 className="lg:ml-[5rem] lg:mt-[2rem] text-[#1A2338] font-roboto-sans lg:text-4xl md:text-lg font-bold">
          OUR ADDRESS
        </h1>
      </div>
      <div className="font-roboto-sans lg:ml-[5rem] bg-[#fff] flex flex-row lg:flex-row mt-4">
        <div className="flex flex-col ml-[5rem]">
          <p className="mt-[13px] lg:mt-[4rem] font-roboto-sans font-bold text-2xl text-[#1A2338]">
            Suchitra Campus: Playschool and <br /> Nursery to Grade 5
          </p>
          <p className="font-roboto-sans  mt-2 lg:mt-[10px] font-bold text-xl text-[#727272]">
            Customer Care No: <br />
            <span className="text-[#727272] text-normal">040 2786 2624</span>
          </p>
          <p className="font-roboto-sans mt-2   font-normal text-xl text-[#727272]">
      ...
      <div className="font-roboto-sans lg:ml-[5rem] bg-[#fff] flex flex-row lg:flex-row mt-4">
        <div className="flex flex-col ml-[5rem]">
          <p className="mt-[13px] lg:mt-[9rem] font-roboto-sans font-bold text-2xl text-[#1A2338]">
