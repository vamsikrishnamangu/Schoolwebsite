...
const Footer = () => {
  return (
    <div
      className="font-roboto-sans lg:w-full lg:h-[428px] w-[390px] h-[504px] bg-gradient-to-r from-[#345FC5] via-[#283B68] to-[#101625] lg:mt-0 mt-[52px]"
      style={{
        backgroundImage:
          "linear-gradient(86.43deg, #345FC5 -12.84%, #283B68 37.49%, #28468B 86.49%, #101625 113.17%)",
      }}
    >
      <div className="font-roboto-sans hidden lg:inline-flex  flex-row space-x-10 2xl:space-x-40  lg:grid-cols-5 gap-8 px-6 py-16">
        <div>
      ...
      <div className="font-roboto-sans lg:hidden grid-cols-2 gap-8 px-6 py-16">
        <div>
