      ...
      <div>
        <div className="bg-[#fff] w-full">
          <div className="flex flex-col lg:flex-row">
            ...
            <div>
              <h1 className=" lg:mt-[11rem] lg:ml-[4rem] ml-[24px] text-[#1A2338] font-Roboto lg:text-4xl text-lg font-bold ">
                START THE ADMISSION PROCESS
              </h1>
              <p className=" font-roboto font-normal text-base leading-[29px] text-[#1A2338]  ml-[24px] lg:ml-[4rem] mt-2 ">
